...
IN_PATH = os.path.join(os.path.dirname(__file__), "..", "..", "results", "sglang", "pin_position1_pilot.csv")
...
print("NOTE: 5-trial pilot only. Not a statistically grounded result yet.")
print("This only checks whether single-digit resolution is visible at all")
print("before committing to a full N=30 x 6-position sweep.")
